...
class Settings(BaseSettings):
    ...
    reranker_provider: str = Field(default="siliconflow", validation_alias=AliasChoices("RERANKER_PROVIDER"))
    reranker_model: str = Field(default="BAAI/bge-reranker-v2-m3", validation_alias=AliasChoices("RERANKER_MODEL"))
    enable_llm_reranker: bool = Field(default=False, validation_alias=AliasChoices("ENABLE_LLM_RERANKER"))
